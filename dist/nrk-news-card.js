...
let NrkNewsCardEditor = class NrkNewsCardEditor extends LitElement {
    setConfig(config) {
        this._config = config;
    }
    get _name() {
...
__decorate([
    property()
], NrkNewsCardEditor.prototype, "hass", void 0);
__decorate([
    property()
], NrkNewsCardEditor.prototype, "_config", void 0);
__decorate([
    property()
], NrkNewsCardEditor.prototype, "_toggle", void 0);
NrkNewsCardEditor = __decorate([
    customElement('nrk-news-card-editor')
], NrkNewsCardEditor);
...
customElements.define('action-handler-nrk-news-card', ActionHandler);
const getActionHandler = () => {
    const body = document.body;
    if (body.querySelector('action-handler-nrk-news-card')) {
        return body.querySelector('action-handler-nrk-news-card');
    }
    const actionhandler = document.createElement('action-handler-nrk-news-card');
...
let NrkNewsCard = class NrkNewsCard extends LitElement {
    ...
    setConfig(config) {
        ...
        this._config = Object.assign({ name: 'NRK news' }, config);
    }
...
__decorate([
    property()
], NrkNewsCard.prototype, "hass", void 0);
__decorate([
    property()
